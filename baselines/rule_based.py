...
# Calculate outputs
seq_len = 250
dataset = mdtk.pytorch_datasets.PianorollDataset('acme/train_pr_corpus.csv', seq_len)
...
dataset = mdtk.pytorch_datasets.PianorollDataset('acme/test_pr_corpus.csv', seq_len)
